...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ Auth::user()->foto ? asset(Auth::user()->foto) : asset('lte/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
        ...
        <nav>
            <ul class="nav nav-pills nav-sidebar flex-column mt-3" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.transaksi-berlangsung.index') }}" class="nav-link" id="berlangsung-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Berlangsung</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <button type="button" class="btn btn-danger nav-link text-white" data-toggle="modal" data-target="#modal-logout">
